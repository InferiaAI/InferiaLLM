...
class ModelCapabilities:
    ...
    CAPABILITIES: Dict[ModelType, Dict[str, Any]] = {
        ...
        ModelType.IMAGE_GENERATION: {
            ...
            "streaming_support": False,
            "gpu_required": True,
            "supported_backends": ["diffusers", "sdxl", "comfyui", "localai"],
        ...
        ModelType.VIDEO_GENERATION: {
            ...
            "streaming_support": False,
            "gpu_required": True,
            "supported_backends": ["diffusers-video", "modelscope", "localai"],
        ...
        ModelType.AUDIO_GENERATION: {
            ...
            "streaming_support": False,
            "gpu_required": False,
            "supported_backends": ["whisper", "bark", "tts", "localai"],
        ...
        ModelType.MULTIMODAL: {
            ...
            "streaming_support": True,
            "gpu_required": True,
            "supported_backends": ["vllm", "llmd", "localai"],
            "default_backend": "vllm",
