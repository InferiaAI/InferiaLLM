...
def build_inference_sdl(
    ...
    service_def = {
        ...
        "resources": {
            ...
            "gpu": {
                "units": gpu_units,
                "attributes": {"vendor": {"nvidia": [{"model": gpu_model}]}},
            },
        },
    }
    ...
    sdl = {
        ...
        "deployment": {service_name: {"dcloud": {"profile": service_name, "count": 1}}},
    }
...
def build_training_sdl(
    ...
    sdl = {
        ...
        "profiles": {
            ...
            "placement": {
                "dcloud": {
                    "pricing": {"training-node": {"denom": "uakt", "amount": 1000}},
                    "signedBy": {"anyOf": ["*"]},
                }
            },
        },
        "deployment": {
            "training-node": {"dcloud": {"profile": "training-node", "count": 1}}
        },
    }
