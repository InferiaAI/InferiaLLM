...
import asyncio
from inferia.services.api_gateway.models import Message, PromptProcessRequest
from inferia.services.api_gateway.gateway.router import process_prompt
import json

# MOCK Prompt Engine to assume behavior
from inferia.services.api_gateway.prompt.engine import prompt_engine
