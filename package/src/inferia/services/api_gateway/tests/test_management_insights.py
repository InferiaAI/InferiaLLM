...
from inferia.services.api_gateway.management.insights import (
    get_insights_filters,
    get_insights_logs,
    get_insights_summary,
    get_insights_timeseries,
)
from inferia.services.api_gateway.schemas.auth import UserContext
...
async def test_insights_summary_requires_permission(monkeypatch):
    ...
    monkeypatch.setattr(
        "inferia.services.api_gateway.management.insights.authz_service.require_permission",
        _deny,
    )
