...
def _patched(tokens):
    ...
    with (
        ...
        patch(
            "inferia.services.api_gateway.management.config_manager.config_manager.save_config",
            save,
        ),
        patch(
            "inferia.services.api_gateway.management.config_manager.config_manager._force_replace_config",
            force_replace,
        ),
        patch(
            "inferia.services.api_gateway.management.configuration.audit_service.log_event",
            AsyncMock(),
        ),
        patch(
            "inferia.services.api_gateway.management.configuration._cleanup_provider_resources",
            AsyncMock(),
        ),
    ):
