...
class TestAuthMiddlewareIntegration:
    ...
    async def test_cached_token_skips_db(self):
        ...
        with patch("inferia.services.api_gateway.rbac.middleware.AsyncSessionLocal") as mock_session:
    ...
    async def test_new_token_populates_cache(self):
        ...
        with patch("inferia.services.api_gateway.rbac.middleware.AsyncSessionLocal", return_value=mock_db), \
             patch("inferia.services.api_gateway.rbac.middleware.auth_service") as mock_svc:
