...
from services.api_gateway.models import UserContext, PermissionEnum
...
from services.api_gateway.rbac.external_org import ensure_external_org
...
async def _resolve_local_token(db, token: str) -> UserContext:
    ...
    from services.api_gateway.db.models import Role
