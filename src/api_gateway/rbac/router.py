...
from api_gateway.rbac.middleware import get_current_user_from_request
...
from api_gateway.models import OrganizationBasicInfo, SwitchOrgRequest, AuditLogCreate
...
async def login(
    ...
    # --- External auth path ---
    if use_external:
        from api_gateway.rbac.external_auth import external_login
...
async def refresh_token(
    ...
    if use_external:
        from api_gateway.rbac.external_auth import external_refresh
