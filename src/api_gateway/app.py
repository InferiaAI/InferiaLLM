...
from api_gateway.gateway.internal_middleware import (
...
from api_gateway.gateway.router import router as gateway_router
from api_gateway.management.router import router as management_router
from api_gateway.rbac.roles_router import router as roles_router
from api_gateway.rbac.users_router import router as users_router
from api_gateway.audit.router import router as audit_router
from api_gateway.gateway.proxy_routes import (
    router as proxy_router,
    worker_passthrough_router,
)
from api_gateway.gateway.health_routes import router as health_router
...
async def _maybe_declare_catalog() -> None:
    ...
    if (
        ...
        from api_gateway.rbac.catalog_declare import declare_catalog
...
async def lifespan(app: FastAPI):
    ...
    if settings.is_external_mode:
        from api_gateway.rbac.external_auth import close_client
        await close_client()
