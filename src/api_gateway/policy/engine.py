...
from api_gateway.db.models import Deployment as DBDeployment
from api_gateway.db.models import Policy as DBPolicy
from api_gateway.db.models import Organization as DBOrganization
...
class PolicyEngine:
    def __init__(self):
        ...
        from api_gateway.gateway.redis_pool import get_redis_client
